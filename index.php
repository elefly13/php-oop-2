...
$cliente1 = new Utente('Anna@gmail.com', 'Anna', 'Rossi','F45UX', 'si');
$cliente2 = new Utente('Pino@gmail.com', 'Pino', 'Verdi','5TYU8', 'si');
$cliente3 = new Utente('Ugo@gmail.com', 'Ugo', 'Neri','VFGY6', 'no');
...
echo $nomePianta2->getDescrizioneArticolo();
